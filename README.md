...
case that excludes the FTPAdapter tests. Als the [trevis-ci.com](https://scrutinizer-ci.com/g/johnnymast/redbox-scan/) test suite implies this package has automated builds and tests to make sure the package is stable with every commit.
